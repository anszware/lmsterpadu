...
import { ref, reactive, mergeProps, withCtx, createTextVNode, unref, createVNode, withModifiers, withDirectives, vModelText, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "admin" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between px-6 py-4 bg-white dark:bg-slate-800 border-b dark:border-slate-700" data-v-668d526e${_scopeId}><h1 class="text-lg font-semibold text-slate-800 dark:text-white capitalize" data-v-668d526e${_scopeId}>Tambah Jurusan</h1><nav class="flex items-center space-x-2 text-sm" data-v-668d526e${_scopeId}>`);
            ...
            _push2(`<span class="text-slate-500 dark:text-slate-400" data-v-668d526e${_scopeId}>Tambah</span></nav></div><div class="p-6" data-v-668d526e${_scopeId}><div class="max-w-2xl bg-white dark:bg-slate-800 rounded-xl shadow-sm border dark:border-slate-700 p-6" data-v-668d526e${_scopeId}><form class="space-y-6" data-v-668d526e${_scopeId}><div class="flex flex-col gap-1.5" data-v-668d526e${_scopeId}><label class="text-xs font-bold text-slate-500 uppercase" data-v-668d526e${_scopeId}>Kode Jurusan</label><input${ssrRenderAttr("value", unref(form).kode_jurusan)} type="text" placeholder="Contoh: RPL, TKJ, AK" class="form-input-custom" required data-v-668d526e${_scopeId}>`);
            if (unref(errors).kode_jurusan) {
              _push2(`<p class="text-[10px] text-rose-500 mt-1" data-v-668d526e${_scopeId}>${ssrInterpolate(unref(errors).kode_jurusan[0])}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex flex-col gap-1.5" data-v-668d526e${_scopeId}><label class="text-xs font-bold text-slate-500 uppercase" data-v-668d526e${_scopeId}>Nama Jurusan</label><input${ssrRenderAttr("value", unref(form).nama_jurusan)} type="text" placeholder="Contoh: Rekayasa Perangkat Lunak" class="form-input-custom" required data-v-668d526e${_scopeId}>`);
            if (unref(errors).nama_jurusan) {
              _push2(`<p class="text-[10px] text-rose-500 mt-1" data-v-668d526e${_scopeId}>${ssrInterpolate(unref(errors).nama_jurusan[0])}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex flex-col gap-1.5" data-v-668d526e${_scopeId}><label class="text-xs font-bold text-slate-500 uppercase" data-v-668d526e${_scopeId}>Deskripsi</label><textarea rows="4" placeholder="Keterangan singkat tentang jurusan ini..." class="form-input-custom" data-v-668d526e${_scopeId}>${ssrInterpolate(unref(form).deskripsi)}</textarea>`);
            if (unref(errors).deskripsi) {
              _push2(`<p class="text-[10px] text-rose-500 mt-1" data-v-668d526e${_scopeId}>${ssrInterpolate(unref(errors).deskripsi[0])}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="pt-4 border-t dark:border-slate-700 flex justify-end gap-3" data-v-668d526e${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: "/admin/jurusan",
            ...
            return [
              createVNode("div", { class: "flex items-center justify-between px-6 py-4 bg-white dark:bg-slate-800 border-b dark:border-slate-700" }, [
                createVNode("h1", { class: "text-lg font-semibold text-slate-800 dark:text-white capitalize" }, "Tambah Jurusan"),
                ...
                createVNode("div", { class: "max-w-2xl bg-white dark:bg-slate-800 rounded-xl shadow-sm border dark:border-slate-700 p-6" }, [
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "pt-4 border-t dark:border-slate-700 flex justify-end gap-3" }, [
                      ...
                      }, toDisplayString(unref(submitting) ? "Menyimpan..." : "Simpan Jurusan"), 9, ["disabled"])
                    ])
                  ], 32)
                ])
              ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/jurusan/create.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-668d526e"]]);

export { create as default };
//# sourceMappingURL=create-BjwA_sTa.mjs.map
