...
class UpdateGuruRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $userId = $guruId ? $guruId->user_id : null;
        $personId = $guruId && $guruId->user ? $guruId->user->person?->id : null;
        ...
        return [
            ...
            // ── Data person ──────────────────────────────────────────
            'nik'            => ['required', 'numeric', 'digits:16', 'unique:people,nik,' . $personId],
            ...
            'nuptk'          => ['nullable', 'string', 'max:20', 'unique:guru,nuptk,' . $guruId?->id],
            'nrg'            => ['nullable', 'string', 'max:20', 'unique:guru,nrg,' . $guruId?->id],
            'nip'            => ['nullable', 'string', 'max:20', 'unique:guru,nip,' . $guruId?->id],
